...
and training data to work for all duckweed species used for scientific experiments and continuously update both here.
...
For installation, install script requirments from the requirments.txt using either pip or conda. It is recomended to install using
a virtual env. 
