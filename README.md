...
For installation, install python requirments from the requirments.txt using either pip or conda in a virtual environment using
python < 3.14. Run run inference.py and follow the instructions given.

Model inference is set up to use the CPU, but only due to the version of pytorch specified in the requirements.txt (GPU is
